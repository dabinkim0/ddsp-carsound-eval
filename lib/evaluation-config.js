...
const STAGE_DEFINITIONS = [
  {
    ...
    introBody:
      "This stage is a comparative study on the application of engine order. Listen to the ground truth first, then rate every shuffled candidate from 0 to 100 using the full slider range.",
    outroTitle: "Stage 1 completed",
    outroBody:
      "You have completed all 16 items in Stage 1. When you continue, Stage 2 will begin with a different comparison objective.",
  ...
  },
  {
    ...
    outroBody:
      "You have completed all 16 items in Stage 2. Your ratings will now be submitted.",
    prompt: "Rate each candidate from 0 to 100 against the Ground Truth.",
    candidates: [
      { id: "reference_test", filename: "reference_test.wav" },
